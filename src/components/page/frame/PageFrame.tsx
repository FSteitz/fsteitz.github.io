    ...
    return (
        <div className="bg-radial-[at_50%_0%] from-[rgb(9,64,116)] via-[rgb(10,10,10)] to-[rgb(9, 64, 116)] bg-size-[175%_275%] bg-center bg-fixed">
            <main className="w-full min-h-298 pt-6">
                <PageNavigation />
                <div className="container mx-auto md:mt-10 sm:px-5">
                    <h1 className="text-2xl md:text-4xl lg:text-5xl text-center font-sans font-bold leading-10 md:leading-14 pt-20 px-8">{pageTitle}</h1>
                    {pageSubTitle &&
                        <h2 className="text-xl md:text-2xl text-center font-sans md:font-semibold pt-6 px-8">{pageSubTitle}</h2>
                    }
